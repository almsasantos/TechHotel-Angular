...
<html lang="en">
<head>
    <title>Code coverage report for src/osm.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> osm.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">78.47% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>565/720</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">55.17% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>128/232</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>458/596</span>
      </div>
    </div>
  </div>
...
2206
2207
2208</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
	function _interopRequireDefault(obj) { return obj &amp;&amp; obj.__esModule ? obj : <span class="branch-1 cbranch-no" title="branch not covered" >{ default: obj };</span> }
&nbsp;
	var osmOAuthModule = angular.module('osm.oauth', [_api2.default.name, _x2js2.default.name]).provider('osmAuthService', <span class="fstat-no" title="function not covered" >function osmAuthServiceProvider() {</span>
<span class="cstat-no" title="statement not covered" >	    this.options = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	    this.$get = <span class="fstat-no" title="function not covered" >function osmAuthServiceFactory($q, osmx2js) {</span></span>
<span class="cstat-no" title="statement not covered" >	        return new _oauth2.default($q, osmx2js, this.options);</span>
	    };
<span class="cstat-no" title="statement not covered" >	    this.$get.$inject = ['$q', 'osmx2js'];</span>
	}); /**
	     * @module osm.oauth
	     */
...
&nbsp;
	...
	var OAuthAdapter = function () {
	     ...
	     */
<span class="fstat-no" title="function not covered" >	    function OAuthAdapter($q, osmx2js, options) {</span>
<span class="cstat-no" title="statement not covered" >	        _classCallCheck(this, OAuthAdapter);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	        if (options) {</span>
<span class="cstat-no" title="statement not covered" >	            if (options.oauth_secret &amp;&amp; options.oauth_consumer_key) {</span>
<span class="cstat-no" title="statement not covered" >	                this.auth = osmAuth(options);</span>
	            }
	        }
<span class="cstat-no" title="statement not covered" >	        this.osmx2js = osmx2js;</span>
...
&nbsp;
	    _createClass(OAuthAdapter, [{
	        key: 'logout',
	        value: <span class="fstat-no" title="function not covered" >function logout() {</span>
<span class="cstat-no" title="statement not covered" >	            this.auth.logout();</span>
	        }
	        /**
	         * @return {boolean}
	         */
&nbsp;
	        ...
	        key: 'authenticated',
	        value: <span class="fstat-no" title="function not covered" >function authenticated() {</span>
<span class="cstat-no" title="statement not covered" >	            return this.auth.authenticated();</span>
	        }
	        /**
...
&nbsp;
	        ...
	        key: 'authenticate',
	        value: <span class="fstat-no" title="function not covered" >function authenticate() {</span>
<span class="cstat-no" title="statement not covered" >	            var deferred = this.$q.defer();</span>
<span class="cstat-no" title="statement not covered" >	            this.auth.authenticate(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >	                deferred.resolve(true);</span>
	            });
...
&nbsp;
	        ...
	        key: 'xhr',
	        value: <span class="fstat-no" title="function not covered" >function xhr(options) {</span>
<span class="cstat-no" title="statement not covered" >	            var self = this;</span>
<span class="cstat-no" title="statement not covered" >	            var deferred = this.$q.defer();</span>
<span class="cstat-no" title="statement not covered" >	            options.path = '/api' + options.path;</span>
<span class="cstat-no" title="statement not covered" >	            if (options.data) {</span>
<span class="cstat-no" title="statement not covered" >	                options.content = options.data;</span>
<span class="cstat-no" title="statement not covered" >	                delete options.data;</span>
	            }
<span class="cstat-no" title="statement not covered" >	            this.auth.xhr(options, <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >	                if (err) {</span>
<span class="cstat-no" title="statement not covered" >	                    deferred.reject(err);</span>
	                } else {
<span class="cstat-no" title="statement not covered" >	                    if (data instanceof XMLDocument) {</span>
<span class="cstat-no" title="statement not covered" >	                        deferred.resolve(self.osmx2js.dom2js(data));</span>
	                    } else {
...
&nbsp;
	        ...
	        key: 'options',
	        value: <span class="fstat-no" title="function not covered" >function options(_options) {</span>
<span class="cstat-no" title="statement not covered" >	            if (this.auth) {</span>
<span class="cstat-no" title="statement not covered" >	                this.auth.options(_options);</span>
	            } else {
<span class="cstat-no" title="statement not covered" >	                this.auth = osmAuth(_options);</span>
	            }
	        }
	    }]);
&nbsp;
...
&nbsp;
	        ...
	        value: function getAuthenticated(method, config) {
	            ...
	            <span class="missing-if-branch" title="else path not taken" >E</span>if (!_config) {
	                _config = {};
	            }
	            _config.method = 'GET';
	            _config.path = method;
...
&nbsp;
	        ...
	        value: function getLastOpenedChangesetId() {
	            ...
	            this.get('/0.6/changesets', config).then(function (data) {
	                ...
	                <span class="missing-if-branch" title="if path not taken" >I</span>if (changesets.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >	                    deferred.resolve(changesets[0].id);</span>
	                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (changesets._id) {
...
&nbsp;
	        ...
	        key: 'getUserById',
	        value: <span class="fstat-no" title="function not covered" >function getUserById(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.getAuthenticated('/0.6/user/' + id);</span>
	        }
&nbsp;
	        /**
	         * @returns {Promise} $http.get response
...
&nbsp;
	        ...
	        key: 'getUserDetails',
	        value: <span class="fstat-no" title="function not covered" >function getUserDetails() {</span>
<span class="cstat-no" title="statement not covered" >	            return this.getAuthenticated('/0.6/user/details');</span>
	        }
	        /**
	         * @returns {Promise} $http.get response
...
&nbsp;
	        ...
	        value: <span class="fstat-no" title="function not covered" >function getUserPreferences() {</span>
<span class="cstat-no" title="statement not covered" >	            return this.getAuthenticated('/0.6/user/preferences');</span>
	        }
&nbsp;
	        /**
...
&nbsp;
	        ...
	        value: <span class="fstat-no" title="function not covered" >function putUserPreferences(key, value) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.put('/0.6/user/preferences/' + key, value);</span>
	        }
&nbsp;
	        //------------------ MAP DATA -------------------------
&nbsp;
...
&nbsp;
	        ...
	        key: 'getMap',
	        value: <span class="fstat-no" title="function not covered" >function getMap(bbox) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/map?bbox=' + bbox);</span>
	        }
&nbsp;
	        /**
	         * @param {string} bbox left,bottom,right,top
...
&nbsp;
	        ...
	        key: 'getNotes',
	        value: <span class="fstat-no" title="function not covered" >function getNotes(bbox) {</span>
<span class="cstat-no" title="statement not covered" >	            var url = '/0.6/notes?bbox=' + bbox;</span>
<span class="cstat-no" title="statement not covered" >	            return this.get(url);</span>
	        }
&nbsp;
	        //------------------ ELEMENTS: Node ----------------
&nbsp;
...
&nbsp;
	        ...
	        key: 'createNode',
	        value: <span class="fstat-no" title="function not covered" >function createNode(node) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.put('/0.6/node/create', node);</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getNode',
	        value: <span class="fstat-no" title="function not covered" >function getNode(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/node/' + id);</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        value: <span class="fstat-no" title="function not covered" >function getNodeRelations(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/node/' + id + '/relations');</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getNodeWays',
	        value: <span class="fstat-no" title="function not covered" >function getNodeWays(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/node/' + id + '/ways');</span>
	        }
&nbsp;
	        /**
	         * @param {array} ids ids
...
&nbsp;
	        ...
	        key: 'getNodes',
	        value: <span class="fstat-no" title="function not covered" >function getNodes(ids) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/nodes?nodes=' + ids.join(','));</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'deleteNode',
	        value: <span class="fstat-no" title="function not covered" >function deleteNode(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.delete('/0.6/node/' + id);</span>
	        }
&nbsp;
	        //------------------ ELEMENTS: WAY ----------------
&nbsp;
...
&nbsp;
	        ...
	        key: 'createWay',
	        value: <span class="fstat-no" title="function not covered" >function createWay(way) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.put('/0.6/way/create', way);</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getWay',
	        value: <span class="fstat-no" title="function not covered" >function getWay(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/way/' + id);</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getWayRelations',
	        value: <span class="fstat-no" title="function not covered" >function getWayRelations(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/way/' + id + '/relations');</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getWayFull',
	        value: <span class="fstat-no" title="function not covered" >function getWayFull(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/way/' + id + '/full');</span>
	        }
&nbsp;
	        /**
	         * @param {array} ids ids
...
&nbsp;
	        ...
	        key: 'getWays',
	        value: <span class="fstat-no" title="function not covered" >function getWays(ids) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/ways?ways=' + ids.join(','));</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'deleteWay',
	        value: <span class="fstat-no" title="function not covered" >function deleteWay(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.delete('/0.6/way/' + id);</span>
	        }
&nbsp;
	        //------------------ ELEMENTS: RELATION ----------------
&nbsp;
...
&nbsp;
	        ...
	        key: 'createRelation',
	        value: <span class="fstat-no" title="function not covered" >function createRelation(relation) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.put('/0.6/relation/create', relation);</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getRelation',
	        value: <span class="fstat-no" title="function not covered" >function getRelation(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/relation/' + id);</span>
	        }
	        /**
	         * @param {string} id id
	         * @returns {Promise} $http.get response
...
&nbsp;
	        ...
	        value: <span class="fstat-no" title="function not covered" >function getRelationRelations(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/relation/' + id + '/relations');</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'getRelationFull',
	        value: <span class="fstat-no" title="function not covered" >function getRelationFull(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/relation/' + id + '/full');</span>
	        }
&nbsp;
	        /**
	         * @param {array} ids ids
...
&nbsp;
	        ...
	        key: 'getRelations',
	        value: <span class="fstat-no" title="function not covered" >function getRelations(ids) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/0.6/relations?relations=' + ids.join(','));</span>
	        }
&nbsp;
	        /**
	         * @param {string} id id
...
&nbsp;
	        ...
	        key: 'deleteRelation',
	        value: <span class="fstat-no" title="function not covered" >function deleteRelation(id) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.delete('/0.6/relation/' + id);</span>
	        }
	    }]);
&nbsp;
	    return OSMAPI;
	    ...
	    _createClass(Base64Adapter, [{
	        ...
	        value: function xhr(options) {
	            ...
	            return this.$http(options).then(function (data) {
	                var d = data.data;
	                <span class="missing-if-branch" title="if path not taken" >I</span>if (!d) {
<span class="cstat-no" title="statement not covered" >	                    return;</span>
	                }
	                <span class="missing-if-branch" title="else path not taken" >E</span>if (d.substr) {
	                    <span class="missing-if-branch" title="else path not taken" >E</span>if (d.substr(0, 5) === '&lt;?xml') {
...
&nbsp;
	        ...
	        value: function clearCredentials() {
	            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.storage.removeItem) {
<span class="cstat-no" title="statement not covered" >	                this.storage.removeItem('credentials');</span>
	            } else {
...
&nbsp;
	function _interopRequireDefault(obj) { return obj &amp;&amp; obj.__esModule ? obj : <span class="branch-1 cbranch-no" title="branch not covered" >{ default: obj };</span> }
&nbsp;
	var osmOverpassModule = angular.module('osm.overpass', []).provider('osmOverpassAPI', <span class="fstat-no" title="function not covered" >function osmOverpassAPIProvider() {</span>
<span class="cstat-no" title="statement not covered" >	    this.options = {</span>
	        url: '//overpass-api.de/api/interpreter'
	    };
<span class="cstat-no" title="statement not covered" >	    this.$get = <span class="fstat-no" title="function not covered" >function osmOverpassAPIFactory($http, $q) {</span></span>
<span class="cstat-no" title="statement not covered" >	        return new _overpass2.default($http, $q, this.options);</span>
	    };
<span class="cstat-no" title="statement not covered" >	    this.$get.$inject = ['$http', '$q'];</span>
	}); /**
	     * @module osm.overpass
	     */
...
&nbsp;
	...
	var OverpassAPI = function () {
	     ...
	     * @param {Object} options
	     */
<span class="fstat-no" title="function not covered" >	    function OverpassAPI($http, $q, options) {</span>
<span class="cstat-no" title="statement not covered" >	        _classCallCheck(this, OverpassAPI);</span>
&nbsp;
...
&nbsp;
	    _createClass(OverpassAPI, [{
	        key: 'overpass',
	        value: <span class="fstat-no" title="function not covered" >function overpass(query) {</span>
...
<span class="cstat-no" title="statement not covered" >	            this.$http.post(url, 'data=' + encodeURIComponent(query), { headers: headers }).then(<span class="fstat-no" title="function not covered" >function (data) {</span></span>
<span class="cstat-no" title="statement not covered" >	                deferred.resolve(data.data);</span>
	            }, <span class="fstat-no" title="function not covered" >function (data) {</span>
<span class="cstat-no" title="statement not covered" >	                deferred.reject(data);</span>
	            });
<span class="cstat-no" title="statement not covered" >	            return deferred.promise;</span>
	        }
	        /**
...
&nbsp;
	        ...
	        key: 'getAreaId',
	        value: <span class="fstat-no" title="function not covered" >function getAreaId(type, osmId) {</span>
<span class="cstat-no" title="statement not covered" >	            var id;</span>
<span class="cstat-no" title="statement not covered" >	            if (typeof osmId === 'string') {</span>
<span class="cstat-no" title="statement not covered" >	                id = parseInt(osmId, 10);</span>
	            } else {
<span class="cstat-no" title="statement not covered" >	                id = osmId;</span>
	            }
<span class="cstat-no" title="statement not covered" >	            if (type === 'r' || type === 'relation') {</span>
<span class="cstat-no" title="statement not covered" >	                return 3600000000 + id;</span>
	            } else <span class="cstat-no" title="statement not covered" >if (type === 'w' || type === 'way') {</span>
<span class="cstat-no" title="statement not covered" >	                return 2400000000 + id;</span>
	            }
	        }
	    }, {
	        key: 'overpassToGeoJSON',
	        value: <span class="fstat-no" title="function not covered" >function overpassToGeoJSON(query, filter) {</span>
<span class="cstat-no" title="statement not covered" >	            var deferred = this.$q.defer();</span>
...
<span class="cstat-no" title="statement not covered" >	            this.overpass(query).then(<span class="fstat-no" title="function not covered" >function (data) {</span></span>
	                //TODO check if data is XML or JSON, here it's JSON
<span class="cstat-no" title="statement not covered" >	                var node, feature, coordinates;</span>
<span class="cstat-no" title="statement not covered" >	                var cache = { loaded: false };</span>
<span class="fstat-no" title="function not covered" >	                function getNodeById(id) {</span>
<span class="cstat-no" title="statement not covered" >	                    if (!cache.loaded) {</span>
<span class="cstat-no" title="statement not covered" >	                        var tmp;</span>
<span class="cstat-no" title="statement not covered" >	                        for (var i = 0; i &lt; data.elements.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >	                            tmp = data.elements[i];</span>
<span class="cstat-no" title="statement not covered" >	                            cache[tmp.id] = tmp;</span>
	                        }
	                    }
<span class="cstat-no" title="statement not covered" >	                    return cache[id];</span>
	                }
<span class="cstat-no" title="statement not covered" >	                for (var i = 0; i &lt; data.elements.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >	                    node = data.elements[i];</span>
<span class="cstat-no" title="statement not covered" >	                    if (node.type === 'node') {</span>
<span class="cstat-no" title="statement not covered" >	                        feature = {</span>
	                            type: 'Feature',
...
<span class="cstat-no" title="statement not covered" >	                        if (!filter(feature)) {</span>
<span class="cstat-no" title="statement not covered" >	                            features.push(feature);</span>
	                        }
	                    } else <span class="cstat-no" title="statement not covered" >if (node.type === 'way') {</span>
<span class="cstat-no" title="statement not covered" >	                        coordinates = [];</span>
<span class="cstat-no" title="statement not covered" >	                        feature = {</span>
	                            type: 'Feature',
	                            properties: node.tags,
	                            id: node.id,
...
<span class="cstat-no" title="statement not covered" >	                        for (var j = 0; j &lt; node.nodes.length; j++) {</span>
<span class="cstat-no" title="statement not covered" >	                            coordinates.push([getNodeById(node.nodes[j]).lon, getNodeById(node.nodes[j]).lat]);</span>
	                        }
<span class="cstat-no" title="statement not covered" >	                        if (!filter(feature)) {</span>
<span class="cstat-no" title="statement not covered" >	                            features.push(feature);</span>
	                        }
	                    } else <span class="cstat-no" title="statement not covered" >if (node.type === 'relation') {</span>
<span class="cstat-no" title="statement not covered" >	                        result.relations.push({</span>
	                            ref: node.id,
	                            tags: node.tags,
	                            type: 'relation',
...
&nbsp;
	        ...
	        this.url = options.url;
	        this.cache = true;
	        <span class="missing-if-branch" title="if path not taken" >I</span>if (options.cache === false) {
<span class="cstat-no" title="statement not covered" >	            this.cache = false;</span>
	        }
	    }
	    /**
...
<span class="cstat-no" title="statement not covered" >	                config = {};</span>
	            ...
	            <span class="missing-if-branch" title="else path not taken" >E</span>if (config.cache === undefined) {
...
&nbsp;
	        ...
	        value: <span class="fstat-no" title="function not covered" >function getKeysWithoutWikiPage(params) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/keys/without_wiki_page', { params: params });</span>
	        }
	        /**
	         * @param {any} params
...
&nbsp;
	        ...
	        value: <span class="fstat-no" title="function not covered" >function getRelationStats(params) {</span>
<span class="cstat-no" title="statement not covered" >	            return this.get('/relation/stats', { params: params });</span>
	        }
	        /**
	         * @param {any} params
	            rtype — Relation type (required).
...
&nbsp;
	    _createClass(NominatimAPI, [{
	        ...
	        value: function search(query) {
	            ...
	            var params;
	            <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof query === 'string' || <span class="branch-1 cbranch-no" title="branch not covered" >!query)</span> {
	                params = {
	                    format: 'json',
	                    q: query
	                };
	            } else {
<span class="cstat-no" title="statement not covered" >	                params = angular.copy(query);</span>
<span class="cstat-no" title="statement not covered" >	                params.format = 'json';</span>
	            }
	            var config = {
	                params: params,
	                cache: this.cache
...
<span class="fstat-no" title="function not covered" >	    function getChangesets(data) {</span>
<span class="cstat-no" title="statement not covered" >	        var result = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	        var nodes = getAsArray(data.osm.changeset);</span>
...
&nbsp;
	        for (var key in way.tags) {
	            <span class="missing-if-branch" title="else path not taken" >E</span>if (options.areaTags.indexOf(key)) {
	                return true;
	            }
	        }
&nbsp;
...
&nbsp;
	        for (var i = 0; i &lt; ways.length; i++) {
	            <span class="missing-if-branch" title="else path not taken" >E</span>if (ways[i].nodes.indexOf(node) &gt;= 0) {
	                used = true;
	                break;
	            }
	        }
...
&nbsp;
	        ...
	        value: function nearest(profile, coordinates, number) {
	            var options;
	            <span class="missing-if-branch" title="if path not taken" >I</span>if (number) {
<span class="cstat-no" title="statement not covered" >	                options = { number: number };</span>
	            }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Nov 21 2016 20:38:17 GMT+0000 (UTC)
</div>
</div>
